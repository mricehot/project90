-- ============================================================================
--  PROJECT 90 — Reset de progresso: escopo reduzido
--
--  Antes, reset_progress() apagava TUDO (diário, tarefas, treino, dicção,
--  bíblia, vocabulário, métricas, conquistas...). Agora ele mexe só em:
--
--    • hábitos  — apaga todos e re-semeia os hábitos-base (a sequência/
--                 streak zera junto, já que o histórico some)
--    • calendário — challenge_meta volta pro dia 1 (início = hoje), 90 dias,
--                   folgas renovadas
--
--  Todo o resto (journal_entries, weekly_reviews, achievements, vocab_*,
--  speech_*, bible_*, tasks, task_completions, wins, streak_counters,
--  night_*, study_*, training_*, meal_*, body_weights, reading_texts)
--  fica intacto.
--
--  app_bootstrap() é redeclarada igual à 0027 (sem mudança), só pra manter
--  o padrão de cada migração trazer as duas funções completas.
--
--  Aplicar depois de 0027_bible_passages.sql.
--  (0021 continua reservada pra feature "Sistema"/RPG.)
-- ============================================================================

-- ============================================================================
--  app_bootstrap() — inalterada em relação à 0027
-- ============================================================================
...
-- ============================================================================
--  reset_progress() — agora só hábitos + calendário
-- ============================================================================
