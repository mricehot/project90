...
drop policy if exists "night_habits: select own" on public.night_habits;
create policy "night_habits: select own" on public.night_habits
  for select using (auth.uid() = user_id);
drop policy if exists "night_habits: insert own" on public.night_habits;
create policy "night_habits: insert own" on public.night_habits
  for insert with check (auth.uid() = user_id);
drop policy if exists "night_habits: update own" on public.night_habits;
create policy "night_habits: update own" on public.night_habits
  for update using (auth.uid() = user_id) with check (auth.uid() = user_id);
drop policy if exists "night_habits: delete own" on public.night_habits;
create policy "night_habits: delete own" on public.night_habits
  for delete using (auth.uid() = user_id);

drop policy if exists "night_routine_days: select own" on public.night_routine_days;
create policy "night_routine_days: select own" on public.night_routine_days
  for select using (auth.uid() = user_id);
drop policy if exists "night_routine_days: insert own" on public.night_routine_days;
create policy "night_routine_days: insert own" on public.night_routine_days
  for insert with check (auth.uid() = user_id);
drop policy if exists "night_routine_days: update own" on public.night_routine_days;
create policy "night_routine_days: update own" on public.night_routine_days
  for update using (auth.uid() = user_id) with check (auth.uid() = user_id);
drop policy if exists "night_routine_days: delete own" on public.night_routine_days;
create policy "night_routine_days: delete own" on public.night_routine_days
  for delete using (auth.uid() = user_id);
...
-- ============================================================================
--  reset_progress() — apaga a rotina noturna (no lugar de daily_closeouts)
-- ============================================================================
